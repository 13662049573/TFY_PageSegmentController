...
@interface WMZPageTitleRightVC ()<PageMunuDelegate,UITableViewDelegate,UITableViewDataSource>{
    BOOL click;
}
@property (nonatomic, strong) TFY_PageMunuView *menuView;
...
- (void)setupView{
    ...
    self.menuView = [[TFY_PageMunuView alloc]initWithFrame:CGRectMake(0, PageVCNavBarHeight, PageVCWidth, 55)];
