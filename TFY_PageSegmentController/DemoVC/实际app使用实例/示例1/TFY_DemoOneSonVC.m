...
@interface TFY_DemoOneSonVC ()<UICollectionViewDelegate, UICollectionViewDataSource,TFY_PageProtocol>
@property(nonatomic,strong)UICollectionView *collectionView;
@end

@implementation TFY_DemoOneSonVC

- (void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:animated];
    TFY_DemoOne *parentVC = (TFY_DemoOne*)self.navigationController.parentViewController;
    [parentVC.upScHerder.mainView setHidden:NO];
}
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:CollectionViewCell];
      // 上拉刷新
    __weak TFY_DemoOneSonVC *weakSelf = self;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    TFY_DemoOne *parentVC = (TFY_DemoOne*)self.navigationController.parentViewController;
    [parentVC.upScHerder.mainView setHidden:YES];
