...
@interface TFY_MeiTuanSonVC ()<UITableViewDelegate,UITableViewDataSource,TFY_PageProtocol>{
    BOOL leftScroll;
}
...
@implementation TFY_MeiTuanSonVC
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    if (tableView == _leftTa) {
        leftScroll = YES;
        TFY_PageBaseController *parentVC = (TFY_PageBaseController*)self.parentViewController;
        if (indexPath.row == 0) {
